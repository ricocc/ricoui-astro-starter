...
It is built for people who want to start from a finished visual language instead of a blank page. The starter includes switchable color themes, Noto Sans SC display typography, class-based dark mode, reusable UI primitives, and MDX-powered blog content.
